...
you first need the .OBB file containing folder which is in the dropbox to place it in the Device/Android/obb folder (it might not work with the phone directly so sometimes you need to make the last move into the folder trought your pc and not the )
...
you can probably also make a [zerotier one](https://d.apkpure.com/b/APK/com.zerotier.one?version=latest) network to play gobally but you can play locally just fine
